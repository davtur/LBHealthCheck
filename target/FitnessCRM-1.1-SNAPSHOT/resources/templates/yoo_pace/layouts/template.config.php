...
$css[] = ".menu-dropdown a.level1 > span, .menu-dropdown span.level1 > span { width: " . $this['config']->get('menubar_width') . "px; }";
$css[] = "#header, #block-main { margin-left: " . ($this['config']->get('menubar_width')+19) . "px; }";
...
$this['asset']->addFile('css', 'css:purefitness.css');
