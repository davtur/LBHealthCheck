...
public class EmailTemplatesController implements Serializable {
    ...
    private List<EmailTemplates> filteredItems;
    private EmailTemplates[] multiSelected;
    ...
    public void setSelected(EmailTemplates selected) {
        if (selected != null) {
            current = selected;
            selectedItemIndex = -1;
        }
    ...
    private EmailTemplatesFacade getFacade() {
        return ejbFacade;
    }
     ...
     */
    public List<EmailTemplates> getFilteredItems() {
     ...
     */
    public void setFilteredItems(List<EmailTemplates> filteredItems) {
     ...
     */
    public EmailTemplates[] getMultiSelected() {
     ...
     */
    public void setMultiSelected(EmailTemplates[] multiSelected) {
    ...
    public String prepareView() {
        //current = (EmailTemplates)getItems().getRowData();
    ...
    public EmailTemplates getSelectedForDeletion() {
        return selectedForDeletion;
    }

    public void setSelectedForDeletion(EmailTemplates selectedForDeletion) {
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(configMapFacade.getConfig("EmailTemplatesDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, configMapFacade.getConfig("PersistenceErrorOccured"));
        }
    }
    ...
    public Collection<EmailTemplates> getItemsAvailable() {
        return ejbFacade.findAll();
    }

    public void onEdit(RowEditEvent event) {
        EmailTemplates cm = (EmailTemplates) event.getObject();
        getFacade().edit(cm);
        recreateModel();
    ...
    @FacesConverter(value = "emailTemplatesControllerConverter")
    public static class EmailTemplatesControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            EmailTemplatesController controller = (EmailTemplatesController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "emailTemplatesController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof EmailTemplates) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + EmailTemplatesController.class.getName());
            }
        }
