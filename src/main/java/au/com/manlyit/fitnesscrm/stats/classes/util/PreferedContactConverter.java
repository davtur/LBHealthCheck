...
@SessionScoped
@FacesConverter(value = "preferedContactConverter")
public class PreferedContactConverter implements Converter, Serializable{
   ...
   @Override
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof PreferedContact) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + PreferedContact.class.getName());
            }
        }
}
