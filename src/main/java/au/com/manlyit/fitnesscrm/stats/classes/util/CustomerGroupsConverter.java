 ...
 * @author david
 */
@Named ("customerGroupsConverter")
@SessionScoped
@FacesConverter(value = "customerGroupsConverter")
public class CustomerGroupsConverter implements Converter, Serializable{

   @Inject
  private  au.com.manlyit.fitnesscrm.stats.beans.GroupsFacade ejbFacade;

   public CustomerGroupsConverter(){
   }
