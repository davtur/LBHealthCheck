...
public class ExpensesController implements Serializable {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(configMapFacade.getConfig("ExpensesCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(configMapFacade.getConfig("ExpensesUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, configMapFacade.getConfig("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(configMapFacade.getConfig("ExpensesDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, configMapFacade.getConfig("PersistenceErrorOccured"));
        }
    }
