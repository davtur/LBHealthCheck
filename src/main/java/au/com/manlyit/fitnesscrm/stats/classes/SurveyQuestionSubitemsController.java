...
public class SurveyQuestionSubitemsController implements Serializable {
   ...
   /**
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(configMapFacade.getConfig("SurveyquestionsubitemsCreated"));
   ...
   public void selectManyMenuValueChangeListener(ValueChangeEvent vce) {
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(configMapFacade.getConfig("SurveyquestionsubitemsUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, configMapFacade.getConfig("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(configMapFacade.getConfig("SurveyquestionsubitemsDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, configMapFacade.getConfig("PersistenceErrorOccured"));
        }
    }
   ...
   public void onEdit(RowEditEvent event) {
    ...
    @FacesConverter(value="surveyQuestionSubitemsControllerConverter", forClass=SurveyQuestionSubitems.class)
