...
public class StatsTakenController implements Serializable {
    ...
    public void prepareCreate() {
        ...
        current.setTrainerComments(" ");
        try {
            current.setImageId(getCustomer().getProfileImage().getId()); //default image
        } catch (Exception e) {
            Logger.getLogger(SessionHistoryController.class.getName()).log(Level.SEVERE, "prepareCreate - The customers profile image id could bnot be found. The image should have been created by default when the customer was first added.", e);
        }
        current.setId(0); // auto generated by DB , but cannot be null
        int count = 0;
    ...
    public void recreateStatModel() {
        FacesContext context = FacesContext.getCurrentInstance();
        StatController statController = context.getApplication().evaluateExpressionGet(context, "#{statController}", StatController.class);
   ...
   /* public CustomerImages prepareCreateCustomerImage() {
        ...
        FacesContext context = FacesContext.getCurrentInstance();
        CustomerImagesController ciController = context.getApplication().evaluateExpressionGet(context, "#{customerImagesController}", CustomerImagesController.class);
